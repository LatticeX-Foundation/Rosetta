...
import numpy as np
from latticex.rosetta.mpc.decorator import MpcTruediv
...
@ops.RegisterGradient("MpcMean")
def MpcMeanGrad(op, grad):
    """The gradient for the Mpc Mean operator."""
    ...
    return MpcTruediv(sum_grad, math_ops.cast(factor, sum_grad.dtype), lh_is_const=False, rh_is_const=True), None
