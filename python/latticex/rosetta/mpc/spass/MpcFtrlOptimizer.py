...
class MpcFtrlOptimizer(tf.train.FtrlOptimizer):
    """
    # mpc Ftrl optimizer, only override __init__ & minimize functions
    """
    ...
    def __init__(self, learning_rate, learning_rate_power=-0.5, initial_accumulator_value=0.1,
        ...
        """
        # Construct a new mpc Ftrl optimizer.
        """
...
# assign mpc ftrl optimizer to ftrl optimizer,
# now, the tf default ftrl optimizer is mpc ftrl optimizer
tf.train.FtrlOptimizer = MpcFtrlOptimizer
