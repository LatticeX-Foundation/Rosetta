...
xcc = sess.run(xxc)
print(xcc)
xc = rtt.SecureMax(xa0, axis=None)
print(xc)
xcc = sess.run(xc)
print(xcc)
...
xcc = sess.run(xxc)
print(xcc)
xc = rtt.SecureMax(xa1, axis=None)
print(xc)
xcc = sess.run(xc)
print(xcc)
...
print(xxc)
xc = rtt.SecureMax(xa2, axis=None)
print(xc)
xcc = sess.run(xc)
print(xcc)
...
xcc = sess.run(xxc)
print(xcc)
xc = rtt.SecureMean(xa0, axis=None)
print(xc)
xcc = sess.run(xc)
print(xcc)
...
xcc = sess.run(xxc)
print(xcc)
xc = rtt.SecureMean(xa1, axis=None)
print(xc)
xcc = sess.run(xc)
print(xcc)
...
print(xxc)
xc = rtt.SecureMean(xa2, axis=None)
print(xc)
xcc = sess.run(xc)
print(xcc)
