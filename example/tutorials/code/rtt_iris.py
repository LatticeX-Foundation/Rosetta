...
training_features_file_path = "/home/juzix/RosettaPlayground/example/tutorials/dsets/P" + str(mpc_player_id) + "/iris_training_features.csv"
training_label_file_path = "/home/juzix/RosettaPlayground/example/tutorials/dsets/P" + str(mpc_player_id) + "/iris_training_label.csv"
...
test_features_file_path = "/home/juzix/RosettaPlayground/example/tutorials/dsets/P" + str(mpc_player_id) + "/iris_test_features.csv"
test_label_file_path = "/home/juzix/RosettaPlayground/example/tutorials/dsets/P" + str(mpc_player_id) + "/iris_test_label.csv"
