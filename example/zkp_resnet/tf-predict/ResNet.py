...
class ResNet(object):
    ...
    def load(self, checkpoint_dir):
        ...
        checkpoint_dir = os.path.join(checkpoint_dir, self.model_dir)
        print("trying to load model from:", checkpoint_dir)
    ...
    def test(self):
        ...
        print("test_accuracy: {}".format(type(test_accuracy)))
        print("test_accuracy: {}".format(test_accuracy))
        # print("test_accuracy: {}".format(test_accuracy[:10, :]))
        np.savetxt('tf-preds-'+self.model_dir+'.csv',
                   test_accuracy, fmt='%.10f')
